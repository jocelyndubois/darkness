...
use TenebresBundle\Entity\Place;
...
class PlaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $places = $em->getRepository('TenebresBundle:Place')->findAll();
    ...
    {
        $place = new Place();
        $form = $this->createForm('TenebresBundle\Form\PlaceType', $place);
    ...
    {
        $deleteForm = $this->createDeleteForm($place);
        $editForm = $this->createForm('TenebresBundle\Form\PlaceType', $place);
